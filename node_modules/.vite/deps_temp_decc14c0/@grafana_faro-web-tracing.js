...
function unsuppressTracing2(context2) {
...
var init_suppress_tracing = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/trace/suppress-tracing.js"() {
    init_esm();
    SUPPRESS_TRACING_KEY2 = createContextKey("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
  }
});

// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/baggage/constants.js
var BAGGAGE_KEY_PAIR_SEPARATOR2, BAGGAGE_PROPERTIES_SEPARATOR2, BAGGAGE_ITEMS_SEPARATOR2, BAGGAGE_HEADER2, BAGGAGE_MAX_NAME_VALUE_PAIRS2, BAGGAGE_MAX_PER_NAME_VALUE_PAIRS2, BAGGAGE_MAX_TOTAL_LENGTH2;
var init_constants = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/baggage/constants.js"() {
    BAGGAGE_KEY_PAIR_SEPARATOR2 = "=";
    BAGGAGE_PROPERTIES_SEPARATOR2 = ";";
    BAGGAGE_ITEMS_SEPARATOR2 = ",";
    BAGGAGE_HEADER2 = "baggage";
    BAGGAGE_MAX_NAME_VALUE_PAIRS2 = 180;
    BAGGAGE_MAX_PER_NAME_VALUE_PAIRS2 = 4096;
    BAGGAGE_MAX_TOTAL_LENGTH2 = 8192;
  }
});

// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/baggage/utils.js
function serializeKeyPairs2(keyPairs) {
  return keyPairs.reduce((hValue, current) => {
    const value = `${hValue}${hValue !== "" ? BAGGAGE_ITEMS_SEPARATOR2 : ""}${current}`;
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/baggage/propagation/W3CBaggagePropagator.js
var W3CBaggagePropagator2;
var init_W3CBaggagePropagator = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/baggage/propagation/W3CBaggagePropagator.js"() {
    ...
    init_constants();
    init_utils4();
    W3CBaggagePropagator2 = class {
      inject(context2, carrier, setter) {
        const baggage = propagation.getBaggage(context2);
        if (!baggage || isTracingSuppressed2(context2))
          return;
        const keyPairs = getKeyPairs2(baggage).filter((pair) => {
          return pair.length <= BAGGAGE_MAX_PER_NAME_VALUE_PAIRS2;
        }).slice(0, BAGGAGE_MAX_NAME_VALUE_PAIRS2);
        const headerValue = serializeKeyPairs2(keyPairs);
        if (headerValue.length > 0) {
          setter.set(carrier, BAGGAGE_HEADER2, headerValue);
        }
      }
      extract(context2, carrier, getter) {
        const headerValue = getter.get(carrier, BAGGAGE_HEADER2);
        const baggageString = Array.isArray(headerValue) ? headerValue.join(BAGGAGE_ITEMS_SEPARATOR2) : headerValue;
        if (!baggageString)
          return context2;
        const baggage = {};
        ...
        const pairs = baggageString.split(BAGGAGE_ITEMS_SEPARATOR2);
        pairs.forEach((entry) => {
          const keyPair = parsePairKeyValue2(entry);
          if (keyPair) {
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/anchored-clock.js
var AnchoredClock2;
var init_anchored_clock = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/anchored-clock.js"() {
    AnchoredClock2 = class {
      /**
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/attributes.js
...
function isAttributeValue2(val) {
  ...
  return isValidPrimitiveAttributeValue2(val);
}
function isHomogeneousAttributeValueArray2(arr) {
  ...
  for (const element of arr) {
    if (element == null)
      continue;
    if (!type) {
      if (isValidPrimitiveAttributeValue2(element)) {
        type = typeof element;
        continue;
      }
      return false;
...
function isValidPrimitiveAttributeValue2(val) {
  switch (typeof val) {
    case "number":
    case "boolean":
    case "string":
...
var delegateHandler2;
var init_global_error_handler = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/global-error-handler.js"() {
    init_logging_error_handler();
    delegateHandler2 = loggingErrorHandler2();
  }
});

// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/environment.js
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/globalThis.js
var _globalThis3;
...
var ATTR_PROCESS_RUNTIME_NAME2;
var init_semconv = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/semconv.js"() {
    ATTR_PROCESS_RUNTIME_NAME2 = "process.runtime.name";
  }
});

// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
var SDK_INFO2;
var init_sdk_info = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js"() {
    ...
    SDK_INFO2 = {
      ...
      [ATTR_PROCESS_RUNTIME_NAME2]: "browser",
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/timer-util.js
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/platform/browser/index.js
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/propagation/composite.js
var CompositePropagator2;
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/trace/TraceState.js
var MAX_TRACE_STATE_ITEMS3, MAX_TRACE_STATE_LEN3, LIST_MEMBERS_SEPARATOR3, LIST_MEMBER_KEY_VALUE_SPLITTER3, TraceState2;
    ...
    TraceState2 = class _TraceState {
      ...
      serialize() {
        return this._keys().reduce((agg, key) => {
          agg.push(key + LIST_MEMBER_KEY_VALUE_SPLITTER3 + this.get(key));
          return agg;
      ...
      _parse(rawTraceState) {
        if (rawTraceState.length > MAX_TRACE_STATE_LEN3)
          return;
        this._internalState = rawTraceState.split(LIST_MEMBERS_SEPARATOR3).reverse().reduce((agg, part) => {
          const listMember = part.trim();
          const i = listMember.indexOf(LIST_MEMBER_KEY_VALUE_SPLITTER3);
          if (i !== -1) {
...
var TRACE_PARENT_HEADER2, TRACE_STATE_HEADER2, VERSION6, VERSION_PART2, TRACE_ID_PART2, PARENT_ID_PART2, FLAGS_PART2, TRACE_PARENT_REGEX2, W3CTraceContextPropagator2;
  ...
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/trace/W3CTraceContextPropagator.js"() {
    ...
    W3CTraceContextPropagator2 = class {
      inject(context2, carrier, setter) {
        ...
        if (!spanContext || isTracingSuppressed2(context2) || !isSpanContextValid(spanContext))
          return;
        const traceParent = `${VERSION6}-${spanContext.traceId}-${spanContext.spanId}-0${Number(spanContext.traceFlags || TraceFlags.NONE).toString(16)}`;
      ...
      extract(context2, carrier, getter) {
        const traceParentHeader = getter.get(carrier, TRACE_PARENT_HEADER2);
        ...
        const traceStateHeader = getter.get(carrier, TRACE_STATE_HEADER2);
        if (traceStateHeader) {
...
function setRPCMetadata2(context2, meta) {
  return context2.setValue(RPC_METADATA_KEY2, meta);
}
function deleteRPCMetadata2(context2) {
  return context2.deleteValue(RPC_METADATA_KEY2);
}
function getRPCMetadata2(context2) {
  return context2.getValue(RPC_METADATA_KEY2);
}
var RPC_METADATA_KEY2, RPCType2;
var init_rpc_metadata = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/trace/rpc-metadata.js"() {
    init_esm();
    RPC_METADATA_KEY2 = createContextKey("OpenTelemetry SDK Context Key RPC_METADATA");
    (function(RPCType6) {
      RPCType6["HTTP"] = "http";
    })(RPCType2 || (RPCType2 = {}));
  }
...
var objectTag2, nullTag2, undefinedTag2, funcProto2, funcToString2, objectCtorString2, getPrototypeOf2, objectProto2, hasOwnProperty2, symToStringTag2, nativeObjectToString2;
var init_lodash_merge = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/lodash.merge.js"() {
    ...
    symToStringTag2 = Symbol ? Symbol.toStringTag : void 0;
    nativeObjectToString2 = objectProto2.toString;
  }
});

// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/merge.js
...
function isObject2(value) {
  return !isPrimitive2(value) && !isArray3(value) && !isFunction2(value) && typeof value === "object";
}
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/timeout.js
...
var init_timeout = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/timeout.js"() {
    TimeoutError2 = class _TimeoutError extends Error {
      constructor(message) {
        super(message);
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/url.js
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/promise.js
var Deferred2;
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/callback.js
var BindOnceFuture2;
var init_callback = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/utils/callback.js"() {
    init_promise();
    BindOnceFuture2 = class {
      constructor(_callback, _that) {
        __publicField(this, "_callback");
        __publicField(this, "_that");
        __publicField(this, "_isCalled", false);
        __publicField(this, "_deferred", new Deferred2());
...
function diagLogLevelFromString2(value) {
  if (value == null) {
    return void 0;
  }
  const resolvedLogLevel = logLevelMap2[value.toUpperCase()];
  if (resolvedLogLevel == null) {
    diag2.warn(`Unknown log level "${value}", expected one of ${Object.keys(logLevelMap2)}, using default`);
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/internal/exporter.js
...
__export(esm_exports, {
  ...
  RPCType: () => RPCType2,
  SDK_INFO: () => SDK_INFO2,
  TRACE_PARENT_HEADER: () => TRACE_PARENT_HEADER2,
  TRACE_STATE_HEADER: () => TRACE_STATE_HEADER2,
  ...
  addHrTimes: () => addHrTimes2,
  callWithTimeout: () => callWithTimeout2,
  deleteRPCMetadata: () => deleteRPCMetadata2,
  diagLogLevelFromString: () => diagLogLevelFromString2,
  getBooleanFromEnv: () => getBooleanFromEnv2,
  getNumberFromEnv: () => getNumberFromEnv2,
  getRPCMetadata: () => getRPCMetadata2,
  getStringFromEnv: () => getStringFromEnv2,
  getStringListFromEnv: () => getStringListFromEnv2,
  getTimeOrigin: () => getTimeOrigin2,
  globalErrorHandler: () => globalErrorHandler2,
  hrTime: () => hrTime2,
  hrTimeDuration: () => hrTimeDuration2,
  hrTimeToMicroseconds: () => hrTimeToMicroseconds2,
  hrTimeToMilliseconds: () => hrTimeToMilliseconds2,
  hrTimeToNanoseconds: () => hrTimeToNanoseconds2,
  hrTimeToTimeStamp: () => hrTimeToTimeStamp2,
  internal: () => internal,
  isAttributeValue: () => isAttributeValue2,
  isTimeInput: () => isTimeInput2,
  isTimeInputHrTime: () => isTimeInputHrTime2,
  isTracingSuppressed: () => isTracingSuppressed2,
  isUrlIgnored: () => isUrlIgnored2,
  loggingErrorHandler: () => loggingErrorHandler2,
  merge: () => merge2,
  millisToHrTime: () => millisToHrTime2,
  otperformance: () => otperformance2,
  parseKeyPairsIntoRecord: () => parseKeyPairsIntoRecord2,
  parseTraceParent: () => parseTraceParent2,
  sanitizeAttributes: () => sanitizeAttributes2,
  setGlobalErrorHandler: () => setGlobalErrorHandler2,
  setRPCMetadata: () => setRPCMetadata2,
  suppressTracing: () => suppressTracing2,
  timeInputToHrTime: () => timeInputToHrTime2,
  unrefTimer: () => unrefTimer2,
  unsuppressTracing: () => unsuppressTracing2,
  urlMatches: () => urlMatches2
});
var internal;
var init_esm3 = __esm({
  "node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/index.js"() {
...
var require_utils = __commonJS({
  "node_modules/@opentelemetry/otlp-transformer/build/src/common/utils.js"(exports) {
    ...
    function hrTimeToNanos(hrTime6) {
      const NANOSECONDS = BigInt(1e9);
      return BigInt(hrTime6[0]) * NANOSECONDS + BigInt(hrTime6[1]);
    }
    ...
    function encodeAsLongBits(hrTime6) {
      const nanos = hrTimeToNanos(hrTime6);
      return toLongBits(nanos);
    }
    exports.encodeAsLongBits = encodeAsLongBits;
    function encodeAsString(hrTime6) {
      const nanos = hrTimeToNanos(hrTime6);
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/baggage/propagation/W3CBaggagePropagator.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/trace/suppress-tracing.js
init_esm();
var SUPPRESS_TRACING_KEY3 = createContextKey("OpenTelemetry SDK Context Key SUPPRESS_TRACING");

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/baggage/utils.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/common/attributes.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/common/logging-error-handler.js
init_esm();
function loggingErrorHandler3() {
  return (ex) => {
    diag2.error(stringifyException3(ex));
  };
}
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/common/global-error-handler.js
...
function getStringListFromEnv3(_) {
  return void 0;
}
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/version.js
var VERSION7 = "2.0.1";

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
init_esm2();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/semconv.js
var ATTR_PROCESS_RUNTIME_NAME4 = "process.runtime.name";

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
var SDK_INFO3 = {
  [ATTR_TELEMETRY_SDK_NAME]: "opentelemetry",
  [ATTR_PROCESS_RUNTIME_NAME4]: "browser",
  [ATTR_TELEMETRY_SDK_LANGUAGE]: TELEMETRY_SDK_LANGUAGE_VALUE_WEBJS,
  [ATTR_TELEMETRY_SDK_VERSION]: VERSION7
};
...
function getTimeOrigin3() {
  let timeOrigin = otperformance3.timeOrigin;
  if (typeof timeOrigin !== "number") {
    const perf = otperformance3;
    timeOrigin = perf.timing && perf.timing.fetchStart;
  }
  return timeOrigin;
}
function hrTime3(performanceNow) {
  ...
  const now = millisToHrTime3(typeof performanceNow === "number" ? performanceNow : otperformance3.now());
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/ExportResult.js
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/propagation/composite.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/trace/W3CTraceContextPropagator.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/internal/validators.js
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/trace/rpc-metadata.js
init_esm();
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/utils/lodash.merge.js
...
function urlMatches3(url, urlToMatch) {
  if (typeof urlToMatch === "string") {
    return url === urlToMatch;
  } else {
    return !!url.match(urlToMatch);
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/utils/configuration.js
init_esm();
var logLevelMap3 = {
  ALL: DiagLogLevel.ALL,
  VERBOSE: DiagLogLevel.VERBOSE,
...
// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/core/build/esm/internal/exporter.js
init_esm();
...
function loggingErrorHandler4() {
  return (ex) => {
    diag2.error(stringifyException4(ex));
  };
}
...
function getStringFromEnv4(_) {
  return void 0;
}

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/version.js
var VERSION8 = "2.0.1";

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
init_esm2();

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/semconv.js
var ATTR_PROCESS_RUNTIME_NAME5 = "process.runtime.name";

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
var SDK_INFO4 = {
  [ATTR_TELEMETRY_SDK_NAME]: "opentelemetry",
  [ATTR_PROCESS_RUNTIME_NAME5]: "browser",
  [ATTR_TELEMETRY_SDK_LANGUAGE]: TELEMETRY_SDK_LANGUAGE_VALUE_WEBJS,
  [ATTR_TELEMETRY_SDK_VERSION]: VERSION8
};
...
var VALID_KEY_CHAR_RANGE5 = "[_0-9a-z-*/]";
var VALID_KEY5 = `[a-z]${VALID_KEY_CHAR_RANGE5}{0,255}`;
var VALID_VENDOR_KEY5 = `[a-z0-9]${VALID_KEY_CHAR_RANGE5}{0,240}@[a-z]${VALID_KEY_CHAR_RANGE5}{0,13}`;
var VALID_KEY_REGEX5 = new RegExp(`^(?:${VALID_KEY5}|${VALID_VENDOR_KEY5})$`);
...
// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/trace/rpc-metadata.js
init_esm();
...
// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/core/build/esm/utils/configuration.js
init_esm();
var logLevelMap4 = {
  ALL: DiagLogLevel.ALL,
  VERBOSE: DiagLogLevel.VERBOSE,
...
// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/resources/build/esm/detect-resources.js
init_esm();

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/resources/build/esm/ResourceImpl.js
init_esm();
init_esm2();

// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/resources/build/esm/detectors/EnvDetector.js
init_esm();
init_esm2();
var EnvDetector = class {
  ...
  detect(_config) {
    ...
    const serviceName = getStringFromEnv4("OTEL_SERVICE_NAME");
    if (rawAttributes) {
      try {
...
// node_modules/@opentelemetry/sdk-trace-base/node_modules/@opentelemetry/resources/build/esm/detectors/NoopDetector.js
...
var ForceFlushState;
(function(ForceFlushState3) {
  ForceFlushState3[ForceFlushState3["resolved"] = 0] = "resolved";
  ForceFlushState3[ForceFlushState3["timeout"] = 1] = "timeout";
  ForceFlushState3[ForceFlushState3["error"] = 2] = "error";
  ForceFlushState3[ForceFlushState3["unresolved"] = 3] = "unresolved";
})(ForceFlushState || (ForceFlushState = {}));

// node_modules/@opentelemetry/sdk-trace-base/build/esm/export/SimpleSpanProcessor.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/sdk-trace-web/build/esm/StackContextManager.js
init_esm();

// node_modules/@opentelemetry/instrumentation-fetch/node_modules/@opentelemetry/sdk-trace-web/build/esm/WebTracerProvider.js
init_esm();
...
(function(PerformanceTimingNames4) {
  ...
  PerformanceTimingNames4["START_TIME"] = "startTime";
...
function findMainRequest(resources, corsPreFlightRequestEndTime, spanEndTimeHR) {
  ...
  for (let i = 1; i < length; i++) {
    ...
    const resourceStartTime = hrTimeToNanoseconds3(timeInputToHrTime3(resource[PerformanceTimingNames.FETCH_START]));
    const resourceEndTime = hrTimeToNanoseconds3(timeInputToHrTime3(resource[PerformanceTimingNames.RESPONSE_END]));
...
function shouldPropagateTraceHeaders(spanUrl, propagateTraceHeaderCorsUrls) {
  ...
  if (parsedSpanUrl.origin === getOrigin()) {
    ...
    return propagateTraceHeaderUrls.some((propagateTraceHeaderUrl) => urlMatches3(spanUrl, propagateTraceHeaderUrl));
  }
}
...
// node_modules/@opentelemetry/instrumentation-fetch/build/esm/fetch.js
var import_semconv7 = __toESM(require_semconv());
init_esm2();
...
function getKnownMethods() {
  if (knownMethods === void 0) {
    const cfgMethods = getStringListFromEnv3("OTEL_INSTRUMENTATION_HTTP_KNOWN_METHODS");
...
var FetchInstrumentation = class extends InstrumentationBase {
  constructor(config = {}) {
    super("@opentelemetry/instrumentation-fetch", VERSION9, config);
    __publicField(this, "component", "fetch");
    __publicField(this, "version", VERSION9);
  ...
  _addFinalSpanAttributes(span, response) {
    ...
    if (this._semconvStability & SemconvStability.OLD) {
      span.setAttribute(import_semconv7.ATTR_HTTP_STATUS_CODE, response.status);
      if (response.statusText != null) {
        span.setAttribute(AttributeNames.HTTP_STATUS_TEXT, response.statusText);
      }
      span.setAttribute(import_semconv7.ATTR_HTTP_HOST, parsedUrl.host);
      span.setAttribute(import_semconv7.ATTR_HTTP_SCHEME, parsedUrl.protocol.replace(":", ""));
      if (typeof navigator !== "undefined") {
        span.setAttribute(import_semconv7.ATTR_HTTP_USER_AGENT, navigator.userAgent);
      }
    }
  ...
  _createSpan(url, options = {}) {
    if (isUrlIgnored3(url, this.getConfig().ignoreUrls)) {
    ...
    if (this._semconvStability & SemconvStability.OLD) {
      ...
      attributes[import_semconv7.ATTR_HTTP_METHOD] = method;
      attributes[import_semconv7.ATTR_HTTP_URL] = url;
    }
    if (this._semconvStability & SemconvStability.STABLE) {
  ...
  _endSpan(span, spanData, response) {
    const endTime = millisToHrTime3(Date.now());
        ...
        if (plugin.getConfig().measureRequestSize) {
          getFetchBodyLength(...args).then((bodyLength) => {
            ...
            if (plugin._semconvStability & SemconvStability.OLD) {
              createdSpan.setAttribute(import_semconv7.ATTR_HTTP_REQUEST_CONTENT_LENGTH_UNCOMPRESSED, bodyLength);
            }
            if (plugin._semconvStability & SemconvStability.STABLE) {
              createdSpan.setAttribute(import_semconv7.ATTR_HTTP_REQUEST_BODY_SIZE, bodyLength);
            }
          }).catch((error) => {
...
// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/baggage/propagation/W3CBaggagePropagator.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/trace/suppress-tracing.js
init_esm();
var SUPPRESS_TRACING_KEY5 = createContextKey("OpenTelemetry SDK Context Key SUPPRESS_TRACING");

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/baggage/utils.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/common/attributes.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/common/logging-error-handler.js
init_esm();
function loggingErrorHandler5() {
  return (ex) => {
    diag2.error(stringifyException5(ex));
  };
}
function stringifyException5(ex) {
  if (typeof ex === "string") {
    return ex;
  } else {
    return JSON.stringify(flattenException5(ex));
  }
}
function flattenException5(ex) {
  const result = {};
  let current = ex;
  while (current !== null) {
    Object.getOwnPropertyNames(current).forEach((propertyName) => {
...
// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/common/global-error-handler.js
var delegateHandler5 = loggingErrorHandler5();
...
function getStringListFromEnv5(_) {
  return void 0;
}
...
var otperformance5 = performance;

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/version.js
var VERSION10 = "2.0.1";

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
init_esm2();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/semconv.js
var ATTR_PROCESS_RUNTIME_NAME6 = "process.runtime.name";

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/platform/browser/sdk-info.js
var SDK_INFO5 = {
  [ATTR_TELEMETRY_SDK_NAME]: "opentelemetry",
  [ATTR_PROCESS_RUNTIME_NAME6]: "browser",
  [ATTR_TELEMETRY_SDK_LANGUAGE]: TELEMETRY_SDK_LANGUAGE_VALUE_WEBJS,
  [ATTR_TELEMETRY_SDK_VERSION]: VERSION10
};

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/common/time.js
var NANOSECOND_DIGITS5 = 9;
var NANOSECOND_DIGITS_IN_MILLIS5 = 6;
var MILLISECONDS_TO_NANOSECONDS5 = Math.pow(10, NANOSECOND_DIGITS_IN_MILLIS5);
var SECOND_TO_NANOSECONDS5 = Math.pow(10, NANOSECOND_DIGITS5);
function millisToHrTime5(epochMillis) {
  const epochSeconds = epochMillis / 1e3;
  const seconds = Math.trunc(epochSeconds);
  const nanos = Math.round(epochMillis % 1e3 * MILLISECONDS_TO_NANOSECONDS5);
  return [seconds, nanos];
}
function getTimeOrigin5() {
  let timeOrigin = otperformance5.timeOrigin;
  if (typeof timeOrigin !== "number") {
    const perf = otperformance5;
    timeOrigin = perf.timing && perf.timing.fetchStart;
  }
  return timeOrigin;
}
function hrTime5(performanceNow) {
  const timeOrigin = millisToHrTime5(getTimeOrigin5());
  const now = millisToHrTime5(typeof performanceNow === "number" ? performanceNow : otperformance5.now());
  return addHrTimes5(timeOrigin, now);
}
function timeInputToHrTime5(time) {
  if (isTimeInputHrTime5(time)) {
    return time;
  } else if (typeof time === "number") {
    if (time < getTimeOrigin5()) {
      return hrTime5(time);
    } else {
      return millisToHrTime5(time);
    }
  } else if (time instanceof Date) {
    return millisToHrTime5(time.getTime());
  } else {
    throw TypeError("Invalid input type");
  }
}
function hrTimeToNanoseconds5(time) {
  return time[0] * SECOND_TO_NANOSECONDS5 + time[1];
}
function isTimeInputHrTime5(value) {
  return Array.isArray(value) && value.length === 2 && typeof value[0] === "number" && typeof value[1] === "number";
}
function addHrTimes5(time1, time2) {
  const out = [time1[0] + time2[0], time1[1] + time2[1]];
  if (out[1] >= SECOND_TO_NANOSECONDS5) {
    out[1] -= SECOND_TO_NANOSECONDS5;
    out[0] += 1;
  }
  return out;
}

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/ExportResult.js
var ExportResultCode5;
(function(ExportResultCode6) {
  ExportResultCode6[ExportResultCode6["SUCCESS"] = 0] = "SUCCESS";
  ExportResultCode6[ExportResultCode6["FAILED"] = 1] = "FAILED";
})(ExportResultCode5 || (ExportResultCode5 = {}));

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/propagation/composite.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/trace/W3CTraceContextPropagator.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/internal/validators.js
var VALID_KEY_CHAR_RANGE6 = "[_0-9a-z-*/]";
var VALID_KEY6 = `[a-z]${VALID_KEY_CHAR_RANGE6}{0,255}`;
var VALID_VENDOR_KEY6 = `[a-z0-9]${VALID_KEY_CHAR_RANGE6}{0,240}@[a-z]${VALID_KEY_CHAR_RANGE6}{0,13}`;
var VALID_KEY_REGEX6 = new RegExp(`^(?:${VALID_KEY6}|${VALID_VENDOR_KEY6})$`);

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/trace/W3CTraceContextPropagator.js
var VERSION_PART5 = "(?!ff)[\\da-f]{2}";
var TRACE_ID_PART5 = "(?![0]{32})[\\da-f]{32}";
var PARENT_ID_PART5 = "(?![0]{16})[\\da-f]{16}";
var FLAGS_PART5 = "[\\da-f]{2}";
var TRACE_PARENT_REGEX5 = new RegExp(`^\\s?(${VERSION_PART5})-(${TRACE_ID_PART5})-(${PARENT_ID_PART5})-(${FLAGS_PART5})(-.*)?\\s?$`);

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/trace/rpc-metadata.js
init_esm();
var RPC_METADATA_KEY5 = createContextKey("OpenTelemetry SDK Context Key RPC_METADATA");
var RPCType5;
(function(RPCType6) {
  RPCType6["HTTP"] = "http";
})(RPCType5 || (RPCType5 = {}));

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/utils/lodash.merge.js
var funcProto5 = Function.prototype;
var funcToString5 = funcProto5.toString;
var objectCtorString5 = funcToString5.call(Object);
...
function urlMatches5(url, urlToMatch) {
  if (typeof urlToMatch === "string") {
    return url === urlToMatch;
  } else {
    return !!url.match(urlToMatch);
...
function isUrlIgnored5(url, ignoredUrls) {
  if (!ignoredUrls) {
    return false;
  }
  for (const ignoreUrl of ignoredUrls) {
    if (urlMatches5(url, ignoreUrl)) {
      return true;
    }
  }
  return false;
...
// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/utils/configuration.js
init_esm();
var logLevelMap5 = {
  ALL: DiagLogLevel.ALL,
  VERBOSE: DiagLogLevel.VERBOSE,
...
// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/core/build/esm/internal/exporter.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/sdk-trace-web/build/esm/StackContextManager.js
init_esm();

// node_modules/@opentelemetry/instrumentation-xml-http-request/node_modules/@opentelemetry/sdk-trace-web/build/esm/WebTracerProvider.js
init_esm();
...
function findMainRequest2(resources, corsPreFlightRequestEndTime, spanEndTimeHR) {
  const spanEndTime = hrTimeToNanoseconds5(spanEndTimeHR);
  const minTime = hrTimeToNanoseconds5(timeInputToHrTime5(corsPreFlightRequestEndTime));
  let mainRequest = resources[1];
  let bestGap;
  const length = resources.length;
  for (let i = 1; i < length; i++) {
    const resource = resources[i];
    const resourceStartTime = hrTimeToNanoseconds5(timeInputToHrTime5(resource[PerformanceTimingNames2.FETCH_START]));
    const resourceEndTime = hrTimeToNanoseconds5(timeInputToHrTime5(resource[PerformanceTimingNames2.RESPONSE_END]));
    const currentGap = spanEndTime - resourceEndTime;
    if (resourceStartTime >= minTime && (!bestGap || currentGap < bestGap)) {
      bestGap = currentGap;
      mainRequest = resource;
...
function filterResourcesForSpan2(spanUrl, startTimeHR, endTimeHR, resources, ignoredResources, initiatorType) {
  const startTime = hrTimeToNanoseconds5(startTimeHR);
  const endTime = hrTimeToNanoseconds5(endTimeHR);
  let filteredResources = resources.filter((resource) => {
    const resourceStartTime = hrTimeToNanoseconds5(timeInputToHrTime5(resource[PerformanceTimingNames2.FETCH_START]));
    const resourceEndTime = hrTimeToNanoseconds5(timeInputToHrTime5(resource[PerformanceTimingNames2.RESPONSE_END]));
    return resource.initiatorType.toLowerCase() === (initiatorType || "xmlhttprequest") && resource.name === spanUrl && resourceStartTime >= startTime && resourceEndTime <= endTime;
...
function shouldPropagateTraceHeaders2(spanUrl, propagateTraceHeaderCorsUrls) {
  ...
  if (parsedSpanUrl.origin === getOrigin2()) {
    ...
    return propagateTraceHeaderUrls.some((propagateTraceHeaderUrl) => urlMatches5(spanUrl, propagateTraceHeaderUrl));
  }
}
...
function getKnownMethods2() {
  if (knownMethods2 === void 0) {
    const cfgMethods = getStringListFromEnv5("OTEL_INSTRUMENTATION_HTTP_KNOWN_METHODS");
    if (cfgMethods && cfgMethods.length > 0) {
      knownMethods2 = {};
      cfgMethods.forEach((m) => {
...
var XMLHttpRequestInstrumentation = class extends InstrumentationBase {
  constructor(config = {}) {
    super("@opentelemetry/instrumentation-xml-http-request", VERSION11, config);
    __publicField(this, "component", "xml-http-request");
    __publicField(this, "version", VERSION11);
    __publicField(this, "moduleName", this.component);
    __publicField(this, "_tasksCount", 0);
  ...
  _createSpan(xhr, url, method) {
    if (isUrlIgnored5(url, this.getConfig().ignoreUrls)) {
      this._diag.debug("ignoring span as url matches ignored url");
      return;
    }
    let name = "";
  ...
  _patchSend() {
    ...
    function endSpan(eventName, xhr, isError, errorType) {
      ...
      const performanceEndTime = hrTime5();
...
var ExceptionEventName2 = "exception";
...
var SpanImpl2 = class {
  ...
  recordException(exception, time) {
    ...
    if (attributes[ATTR_EXCEPTION_TYPE] || attributes[ATTR_EXCEPTION_MESSAGE]) {
      this.addEvent(ExceptionEventName2, attributes, time);
    } else {
...
var ParentBasedSampler2 = class {
  constructor(config) {
    ...
    this._remoteParentSampled = config.remoteParentSampled ?? new AlwaysOnSampler2();
    this._remoteParentNotSampled = config.remoteParentNotSampled ?? new AlwaysOffSampler2();
    this._localParentSampled = config.localParentSampled ?? new AlwaysOnSampler2();
    this._localParentNotSampled = config.localParentNotSampled ?? new AlwaysOffSampler2();
  }
...
function buildSamplerFromEnv2() {
  ...
  switch (sampler) {
    ...
    case TracesSamplerValues.TraceIdRatio:
      return new TraceIdRatioBasedSampler2(getSamplerProbabilityFromEnv());
    case TracesSamplerValues.ParentBasedTraceIdRatio:
      return new ParentBasedSampler2({
        root: new TraceIdRatioBasedSampler2(getSamplerProbabilityFromEnv())
      });
    default:
...
function mergeConfig2(userConfig) {
...
init_esm();
var BatchSpanProcessorBase2 = class {
...
var BatchSpanProcessor2 = class extends BatchSpanProcessorBase2 {
  constructor(_exporter, config) {
...
var Tracer2 = class {
  ...
  constructor(instrumentationScope, config, resource, spanProcessor) {
    ...
    __publicField(this, "_spanProcessor");
    const localConfig = mergeConfig2(config);
...
var ForceFlushState2;
(function(ForceFlushState3) {
  ForceFlushState3[ForceFlushState3["resolved"] = 0] = "resolved";
  ForceFlushState3[ForceFlushState3["timeout"] = 1] = "timeout";
  ForceFlushState3[ForceFlushState3["error"] = 2] = "error";
  ForceFlushState3[ForceFlushState3["unresolved"] = 3] = "unresolved";
})(ForceFlushState2 || (ForceFlushState2 = {}));
var BasicTracerProvider2 = class {
  constructor(config = {}) {
    ...
    this._activeSpanProcessor = new MultiSpanProcessor2(spanProcessors);
  }
  getTracer(name, version, options) {
    const key = `${name}@${version || ""}:${(options == null ? void 0 : options.schemaUrl) || ""}`;
    if (!this._tracers.has(key)) {
      this._tracers.set(key, new Tracer2({ name, version, schemaUrl: options == null ? void 0 : options.schemaUrl }, this._config, this._resource, this._activeSpanProcessor));
    }
  ...
  forceFlush() {
    ...
    const promises = this._activeSpanProcessor["_spanProcessors"].map((spanProcessor) => {
      return new Promise((resolve) => {
        ...
        const timeoutInterval = setTimeout(() => {
          ...
          state = ForceFlushState2.timeout;
        }, timeout);
        spanProcessor.forceFlush().then(() => {
          clearTimeout(timeoutInterval);
          if (state !== ForceFlushState2.timeout) {
            state = ForceFlushState2.resolved;
            resolve(state);
          }
        }).catch((error) => {
          clearTimeout(timeoutInterval);
          state = ForceFlushState2.error;
          resolve(error);
        });
      });
    });
    return new Promise((resolve, reject) => {
      Promise.all(promises).then((results) => {
        const errors = results.filter((result) => result !== ForceFlushState2.resolved);
        if (errors.length > 0) {
          reject(errors);
        } else {
          resolve();
...
// node_modules/@opentelemetry/sdk-trace-web/node_modules/@opentelemetry/sdk-trace-base/build/esm/export/SimpleSpanProcessor.js
init_esm();

// node_modules/@opentelemetry/sdk-trace-web/build/esm/StackContextManager.js
init_esm();
var StackContextManager3 = class {
  constructor() {
    /**
...
function setupContextManager(contextManager) {
  ...
  if (contextManager === void 0) {
    const defaultContextManager = new StackContextManager3();
...
var WebTracerProvider3 = class extends BasicTracerProvider2 {
  /**
   * Constructs a new Tracer instance.
...
function getSamplingDecision(sessionMeta = {}) {
  ...
  const samplingDecision = isSessionSampled ? SamplingDecision3.RECORD_AND_SAMPLED : SamplingDecision3.NOT_RECORD;
...
var TracingInstrumentation = class _TracingInstrumentation extends BaseInstrumentation {
  ...
  initialize() {
    ...
    attributes[ATTR_PROCESS_RUNTIME_NAME3] = "browser";
    ...
    const resource = defaultResource2().merge(resourceFromAttributes2(attributes));
    const provider = new WebTracerProvider3({
      resource,
      sampler: {
        shouldSample: () => {
          return {
      ...
      spanProcessors: [
        (_b = options.spanProcessor) !== null && _b !== void 0 ? _b : new FaroUserActionSpanProcessor(new FaroMetaAttributesSpanProcessor(new BatchSpanProcessor2(new FaroTraceExporter({ api: this.api }), {
